    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="refreshApp.operation.home.createOrEditLabel">Create or edit a Operation</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="operation-date">Date</label>
                        <div class="d-flex">
                        ...
                        <div v-if="$v.operation.date.$anyDirty && $v.operation.date.$invalid">
                            <small class="form-text text-danger" v-if="!$v.operation.date.required">
                                This field is required.
                            </small>
                            <small class="form-text text-danger" v-if="!$v.operation.date.ZonedDateTimelocal">
                                This field should be a date and time.
                            </small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" for="operation-description">Description</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="operation-amount">Amount</label>
                        ...
                        <div v-if="$v.operation.amount.$anyDirty && $v.operation.amount.$invalid">
                            <small class="form-text text-danger" v-if="!$v.operation.amount.required">
                                This field is required.
                            </small>
                            <small class="form-text text-danger" v-if="!$v.operation.amount.number">
                                This field should be a number.
                            </small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="operation-label">Label</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label"  for="operation-bankAccount">Bank Account</label>
